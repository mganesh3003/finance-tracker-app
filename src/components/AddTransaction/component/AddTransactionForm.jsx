...
import { addTransaction, addCategory, updateTransaction } from '../../../features/transactionSlice';
...
const AddTransactionForm = ({ open, onClose, transactionToEdit }) => {
  ...
  const handleAddTransaction = () => {
    ...
    if (transactionToEdit) {
      ...
      dispatch(updateTransaction({ id: transactionToEdit.id, data: newTransaction }));
    } else {
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      ...
      <DialogContent>
        ...
        {errors.category && <Typography variant="caption" color="error">Please select or add a category</Typography>}
        <TextField
        ...
        <TextField
          ...
          error={errors.amount}
        />
        {errors.amount && <Typography variant="caption" color="error">Please enter a valid amount</Typography>}
        <TextField
          type="date"
          label="Date"
          value={date}
