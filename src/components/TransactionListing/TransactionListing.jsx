...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Typography, TablePagination, IconButton, Box } from '@mui/material';
...
const TransactionTable = () => {
  ...
  const slicedTransactions = filteredTransactions.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage);
  ...
  return (
    <>
          ...
          <TableBody>
            {slicedTransactions.map((transaction) => (
              <TableRow key={transaction.id}>
                ...
                <TableCell>
                  <IconButton onClick={() => handleEditClick(transaction)} aria-label="edit">
                    <EditIcon color="primary"/>
                  </IconButton>
                  <IconButton onClick={() => handleDeleteClick(transaction.id)} aria-label="delete">
      ...
      />
      <AddTransactionForm open={openEditForm} onClose={() => setOpenEditForm(false)} transactionToEdit={transactionToEdit} />
    </>
  );
};
